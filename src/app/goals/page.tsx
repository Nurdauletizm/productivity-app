    ...
    return (
        <div className="flex flex-col h-full bg-[#fbfbfa] dark:bg-[#0a0a0a] relative transition-colors">
            <header className="px-4 md:px-8 py-4 md:py-6 border-b border-gray-100 dark:border-zinc-800 flex items-center justify-between sticky top-0 bg-white/80 dark:bg-[#121212]/80 backdrop-blur-sm z-10 transition-colors">
                <div>
                    <h1 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-zinc-100 tracking-tight">Цели</h1>
                    <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1 hidden sm:block">Отслеживайте свои глобальные цели и прогресс.</p>
                </div>
            ...
            <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                {isLoading || !goals ? (
                    <div className="flex justify-center text-gray-400 dark:text-zinc-500 mt-10 transition-colors">Загрузка целей...</div>
                ) : goals.length === 0 ? (
                    <div className="flex flex-col items-center justify-center text-center mt-20">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 dark:text-zinc-100">Пока нет целей</h3>
                        <p className="text-gray-500 dark:text-zinc-400 mt-1">Создайте первую цель для отслеживания прогресса.</p>
                    </div>
                ) : (
