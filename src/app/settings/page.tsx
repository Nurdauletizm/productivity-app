...
export default function SettingsPage() {
    ...
    const handleSaveProfile = async () => {
        setSaving(true);
        // В будущем здесь будет API для обновления профиля
    ...
    const handleDeleteAccount = async () => {
        ...
        // В будущем здесь будет API для удаления аккаунта
        ...
        switch (activeTab) {
                ...
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div className="border-b border-gray-100 dark:border-zinc-800 pb-5">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">Мой профиль</h2>
                            <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">Управляйте личной информацией и аватаром.</p>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="flex-shrink-0 relative group cursor-pointer">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                    <span className="text-xs font-medium text-gray-900 dark:text-white bg-white/80 dark:bg-black/50 px-2 py-1 rounded backdrop-blur-sm shadow-sm">Изменить</span>
                                </div>
                            </div>
                            <div>
                                <h3 className="text-base font-medium text-gray-900 dark:text-zinc-100">Аватар</h3>
                                <p className="text-sm text-gray-500 dark:text-zinc-400 mt-0.5">JPEG, PNG или GIF. Макс. 2 МБ.</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1.5">Полное имя</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled
                                    className="w-full px-4 py-2.5 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700/50 rounded-lg focus:outline-none transition-all dark:text-zinc-100 opacity-60 cursor-not-allowed"
                                />
                            </div>
                        </div>
                        ...
                        <div className="pt-6 flex justify-end">
                            <button
                                ...
                                disabled={saving}
                                className="px-6 py-2.5 bg-black dark:bg-white text-white dark:text-black rounded-lg text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors border border-transparent dark:border-zinc-700 shadow-sm disabled:opacity-50"
                            >
            ...
            case "preferences":
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div className="border-b border-gray-100 dark:border-zinc-800 pb-5">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">Настройки</h2>
                            <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">Настройте внешний вид и региональные параметры.</p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-xl p-5 shadow-sm">
                            <div className="flex items-start gap-4 flex-col lg:flex-row">
                                ...
                                <div className="flex-1 w-full">
                                    <h3 className="text-base font-medium text-gray-900 dark:text-zinc-100">Тема оформления</h3>
                                    <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1 mb-4">Выберите как приложение будет выглядеть.</p>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-gray-900 dark:text-zinc-300">Светлая</span>
                                        </button>
                                        <button
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-gray-900 dark:text-zinc-300">Тёмная</span>
                                        </button>
                                        <button
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-gray-900 dark:text-zinc-300">Системная</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 flex-col lg:flex-row">
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                                    <div className="w-full">
                                        <h3 className="text-base font-medium text-gray-900 dark:text-zinc-100 mb-1">Начало недели</h3>
                                        <p className="text-sm text-gray-500 dark:text-zinc-400 mb-3">С какого дня начинается ваша неделя?</p>
                                    ...
                                    <div className="w-full">
                                        <h3 className="text-base font-medium text-gray-900 dark:text-zinc-100 mb-1">Формат времени</h3>
                                        <p className="text-sm text-gray-500 dark:text-zinc-400 mb-3">Как отображать время?</p>
                                        <select className="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-zinc-600 transition-all dark:text-zinc-200 cursor-pointer">
                                            <option value="24h">24-часовой (13:00)</option>
                                            <option value="12h">12-часовой (1:00 PM)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            case "security":
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div className="border-b border-gray-100 dark:border-zinc-800 pb-5">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">Безопасность</h2>
                            <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">Управляйте подключёнными аккаунтами и данными.</p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-xl p-5 shadow-sm mb-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 flex justify-between items-center sm:flex-row flex-col sm:items-center items-start gap-3">
                                    <div>
                                        <h3 className="text-base font-medium text-gray-900 dark:text-zinc-100">Google авторизация</h3>
                                        <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">Вы вошли через Google OAuth.</p>
                                    </div>
                        ...
                        <div className="bg-red-50/50 dark:bg-red-950/10 border border-red-100 dark:border-red-900/30 rounded-xl p-6 shadow-sm overflow-hidden relative">
                            ...
                            <div className="flex items-start gap-4 relative z-10 flex-col sm:flex-row">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-base font-medium text-red-900 dark:text-red-400">Опасная зона</h3>
                                    <p className="text-sm text-red-700/80 dark:text-red-400/80 mt-1 max-w-lg">
                                        После удаления аккаунта пути назад нет. Все ваши цели, задачи и данные будут удалены навсегда.
                                    </p>
                                    <button
                                        onClick={handleDeleteAccount}
                                        className="mt-5 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white dark:bg-red-600/90 dark:hover:bg-red-600 rounded-lg text-sm font-medium transition-colors shadow-sm focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-950"
                                    >
                                        Удалить аккаунт
                                    </button>
                                </div>
    ...
    return (
        <div className="flex flex-col h-full bg-[#fbfbfa] dark:bg-[#0a0a0a] transition-colors">
            <header className="px-8 py-6 border-b border-gray-100 dark:border-zinc-800 flex items-center justify-between bg-white/80 dark:bg-[#121212]/80 backdrop-blur-sm sticky top-0 z-10 shrink-0 transition-colors">
                <div>
                    <h1 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 tracking-tight">Настройки</h1>
                    <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1 leading-relaxed">
                        Управляйте параметрами аккаунта.
                    </p>
                </div>
            </header>
